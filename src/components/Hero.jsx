          ...
          <div className="w-full flex justify-center relative">
            <div className="flex flex-col relative w-fit mr-[10%] lg:mr-[15%] mt-[-5%]">
              ...
              <div className="w-full flex justify-center ml-[5%] lg:ml-[15%] xl:ml-[18%] mt-[-1%]">
                <span className="font-sans font-medium uppercase text-[8vw] lg:text-[9vw] xl:text-[9.5rem] tracking-[-0.02em] leading-[0.95] whitespace-nowrap text-[#FFFFFF]">The-Service</span>
              </div>
