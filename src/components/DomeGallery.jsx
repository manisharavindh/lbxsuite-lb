...
function buildItems(pool, seg) {
  ...
  const coords = xCols.flatMap((x, c) => {
    ...
    return ys.map(y => ({ x, y, sizeX: 2.8, sizeY: 1.8 })); // Ensure these visually fit without overlapping based on steps
  });
...
export default function DomeGallery({
  ...
  return (
    <section className="w-full relative py-24 bg-[#141414] overflow-hidden border-t border-white/5">
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 relative z-20 mb-12">
        <h2 className="text-3xl md:text-[2.5rem] lg:text-[2.75rem] leading-[1.15] font-serif text-[#FFFFFF]">
          Selected Works
        </h2>
        <p className="text-[#A9A9A9] font-sans md:text-lg mt-4 max-w-xl">
          A showcase of some of our recent high-performance digital products and web experiences. Drag to explore.
        </p>
      </div>
