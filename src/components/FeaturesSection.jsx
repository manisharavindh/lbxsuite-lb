...
const FeaturesSection = () => {
  ...
  // Container dynamically widens smoothly using clip-path to prevent severe browser layout thrashing on scroll!
  const containerClipPath = useTransform(scrollYProgress, [0.1, 0.8], ["inset(0% 5vw round 24px)", "inset(0% 0vw round 0px)"]);
  ...
  const imageY = useTransform(smoothProgress, [0.2, 1], [100, 0]);
  const imageScale = useTransform(smoothProgress, [0.2, 1], [1, 1.3]);
        ...
        >
          ...
          <div className="w-full flex-[1_1_100%] min-h-0 relative flex justify-center items-start pointer-events-none z-0 mt-4 md:mt-8">
            <motion.img
              ...
              className="w-full h-full object-contain object-top z-0 origin-top"
